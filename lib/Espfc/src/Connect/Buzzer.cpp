...
const uint8_t** Buzzer::schemes()
{
  ...
  static const uint8_t* beeperSchemes[] = {
      ...
      beeperRxLost,
      // BUZZER_RX_LOST_LANDING,         // Beeps SOS when armed and TX is turned off or signal lost
      // (autolanding/autodisarm)
      beeperSilence,
      ...
      // ****
      beeperSilence,
      // BUZZER_RX_SET,                  // Beeps when aux channel is set for beep or beep sequence how many satellites
      // has found if GPS enabled
      beeperRxLost,
      ...
      beeperSilence,
      // BUZZER_ARMED,                   // Warning beeps when board is armed (repeats until board is disarmed or
